...
4. Remove every bold that is not a heading or a list label, plus any heading or
   list that does not earn its place.
5. Replace any em-dash or en-dash with a hyphen, or with better punctuation.
6. Confirm that brevity did not remove a caveat the reader needs.
